if Code.ensure_loaded?(SandboxRegistry) do
  defmodule AWS.IdentityCenter.Sandbox do
    ...
    def list_instances_response(opts) do
      ...
      func = AWS.Sandbox.find!(@registry, __MODULE__, :list_instances, "*", examples)
    ...
    def create_permission_set_response(name, opts) do
      ...
      func = AWS.Sandbox.find!(@registry, __MODULE__, :create_permission_set, name, examples)
    ...
    def delete_permission_set_response(arn, opts) do
      ...
      func = AWS.Sandbox.find!(@registry, __MODULE__, :delete_permission_set, arn, examples)
    ...
    def list_permission_sets_response(instance_arn, opts) do
      examples = AWS.Sandbox.doc_examples([:instance_arn])

      func =
        AWS.Sandbox.find!(@registry, __MODULE__, :list_permission_sets, instance_arn, examples)

      AWS.Sandbox.apply_func(func, [instance_arn, opts], examples)
    end
    ...
    def describe_permission_set_response(instance_arn, permission_set_arn, opts) do
      examples = AWS.Sandbox.doc_examples([:instance_arn, :permission_set_arn])

      func =
        AWS.Sandbox.find!(@registry, __MODULE__, :describe_permission_set, instance_arn, examples)

      AWS.Sandbox.apply_func(func, [instance_arn, permission_set_arn, opts], examples)
    end
    ...
    def put_inline_policy_to_permission_set_response(
      ...
      examples = AWS.Sandbox.doc_examples([:instance_arn, :permission_set_arn, :policy])
      ...
      AWS.Sandbox.apply_func(func, [instance_arn, permission_set_arn, policy, opts], examples)
    end
    ...
    def list_account_assignments_response(instance_arn, account_id, permission_set_arn, opts) do
      examples = AWS.Sandbox.doc_examples([:instance_arn, :account_id, :permission_set_arn])
      ...
      AWS.Sandbox.apply_func(func, [instance_arn, account_id, permission_set_arn, opts], examples)
    end
    ...
    def attach_managed_policy_to_permission_set_response(ps_arn, opts) do
      examples = AWS.Sandbox.doc_examples([:ps_arn])
      ...
      AWS.Sandbox.apply_func(func, [ps_arn, opts], examples)
    end
    ...
    def provision_permission_set_response(permission_set_arn, opts) do
      examples = AWS.Sandbox.doc_examples([:permission_set_arn])
      ...
      AWS.Sandbox.apply_func(func, [permission_set_arn, opts], examples)
    end
    ...
    def create_identity_store_user_response(username, opts) do
      examples = AWS.Sandbox.doc_examples([:username])

      func =
        AWS.Sandbox.find!(@registry, __MODULE__, :create_identity_store_user, username, examples)

      AWS.Sandbox.apply_func(func, [username, opts], examples)
    end
    ...
    def delete_identity_store_user_response(user_id, opts) do
      examples = AWS.Sandbox.doc_examples([:user_id])

      func =
        AWS.Sandbox.find!(@registry, __MODULE__, :delete_identity_store_user, user_id, examples)

      AWS.Sandbox.apply_func(func, [user_id, opts], examples)
    end
    ...
    def update_identity_store_user_response(user_id, opts) do
      ...
      func =
        AWS.Sandbox.find!(@registry, __MODULE__, :update_identity_store_user, user_id, examples)
    ...
    def describe_identity_store_user_response(user_id, opts) do
      ...
      func =
        AWS.Sandbox.find!(@registry, __MODULE__, :describe_identity_store_user, user_id, examples)
    ...
    def list_identity_store_users_response(store_id, opts) do
      examples = AWS.Sandbox.doc_examples([:store_id])

      func =
        AWS.Sandbox.find!(@registry, __MODULE__, :list_identity_store_users, store_id, examples)

      AWS.Sandbox.apply_func(func, [store_id, opts], examples)
    end
    ...
    def create_identity_store_group_response(name, opts) do
      ...
      func =
        AWS.Sandbox.find!(@registry, __MODULE__, :create_identity_store_group, name, examples)
    ...
    def delete_identity_store_group_response(group_id, opts) do
      ...
      func =
        AWS.Sandbox.find!(@registry, __MODULE__, :delete_identity_store_group, group_id, examples)
    ...
    def list_identity_store_groups_response(store_id, opts) do
      ...
      func =
        AWS.Sandbox.find!(@registry, __MODULE__, :list_identity_store_groups, store_id, examples)
    ...
    def create_group_membership_response(group_id, opts) do
      ...
      func =
        AWS.Sandbox.find!(@registry, __MODULE__, :create_group_membership, group_id, examples)
    ...
    def delete_group_membership_response(membership_id, opts) do
      examples = AWS.Sandbox.doc_examples([:membership_id])
      ...
      AWS.Sandbox.apply_func(func, [membership_id, opts], examples)
    end
