if Code.ensure_loaded?(SandboxRegistry) do
  defmodule AWS.Logs.Sandbox do
    ...
    def disable_aws_logs_sandbox(_context), do: AWS.Sandbox.disable(@registry, __MODULE__)
    ...
    def create_log_group_response(name, opts) do
      ...
      func = AWS.Sandbox.find!(@registry, __MODULE__, :create_log_group, name, examples)
    ...
    def delete_log_group_response(name, opts) do
      examples = AWS.Sandbox.doc_examples([:name])
      func = AWS.Sandbox.find!(@registry, __MODULE__, :delete_log_group, name, examples)
      AWS.Sandbox.apply_func(func, [name, opts], examples)
    end
    ...
    def describe_log_groups_response(opts) do
      ...
      func = AWS.Sandbox.find!(@registry, __MODULE__, :describe_log_groups, "*", examples)
    ...
    def put_retention_policy_response(name, days, opts) do
      examples = AWS.Sandbox.doc_examples([:name, :days])
      func = AWS.Sandbox.find!(@registry, __MODULE__, :put_retention_policy, name, examples)
      AWS.Sandbox.apply_func(func, [name, days, opts], examples)
    end
    ...
    def delete_retention_policy_response(name, opts) do
      examples = AWS.Sandbox.doc_examples([:name])
      func = AWS.Sandbox.find!(@registry, __MODULE__, :delete_retention_policy, name, examples)
      AWS.Sandbox.apply_func(func, [name, opts], examples)
    end
    ...
    def create_log_stream_response(group, stream, opts) do
      examples = AWS.Sandbox.doc_examples([:group, :stream])
      func = AWS.Sandbox.find!(@registry, __MODULE__, :create_log_stream, group, examples)
      AWS.Sandbox.apply_func(func, [group, stream, opts], examples)
    end
    ...
    def delete_log_stream_response(group, stream, opts) do
      examples = AWS.Sandbox.doc_examples([:group, :stream])
      func = AWS.Sandbox.find!(@registry, __MODULE__, :delete_log_stream, group, examples)
      AWS.Sandbox.apply_func(func, [group, stream, opts], examples)
    end
    ...
    def describe_log_streams_response(group, opts) do
      examples = AWS.Sandbox.doc_examples([:group])
      func = AWS.Sandbox.find!(@registry, __MODULE__, :describe_log_streams, group, examples)
      AWS.Sandbox.apply_func(func, [group, opts], examples)
    end
    ...
    def put_log_events_response(group, stream, events, opts) do
      examples = AWS.Sandbox.doc_examples([:group, :stream, :events])
      func = AWS.Sandbox.find!(@registry, __MODULE__, :put_log_events, group, examples)
      AWS.Sandbox.apply_func(func, [group, stream, events, opts], examples)
    end
    ...
    def get_log_events_response(group, stream, opts) do
      examples = AWS.Sandbox.doc_examples([:group, :stream])
      func = AWS.Sandbox.find!(@registry, __MODULE__, :get_log_events, group, examples)
      AWS.Sandbox.apply_func(func, [group, stream, opts], examples)
    end
    ...
    def filter_log_events_response(group, opts) do
      examples = AWS.Sandbox.doc_examples([:group])
      func = AWS.Sandbox.find!(@registry, __MODULE__, :filter_log_events, group, examples)
      AWS.Sandbox.apply_func(func, [group, opts], examples)
    end
    ...
    def start_query_response(group, start_time, end_time, query, opts) do
      examples = AWS.Sandbox.doc_examples([:group, :start_time, :end_time, :query])
      func = AWS.Sandbox.find!(@registry, __MODULE__, :start_query, group, examples)
      AWS.Sandbox.apply_func(func, [group, start_time, end_time, query, opts], examples)
    end
    ...
    def start_query_for_log_groups_response(groups, start_time, end_time, query, opts) do
      examples = AWS.Sandbox.doc_examples([:groups, :start_time, :end_time, :query])
      ...
      AWS.Sandbox.apply_func(func, [groups, start_time, end_time, query, opts], examples)
    end
    ...
    def start_query_by_identifiers_response(identifiers, start_time, end_time, query, opts) do
      examples = AWS.Sandbox.doc_examples([:identifiers, :start_time, :end_time, :query])
      ...
      AWS.Sandbox.apply_func(func, [identifiers, start_time, end_time, query, opts], examples)
    end
    ...
    def get_query_results_response(query_id, opts) do
      examples = AWS.Sandbox.doc_examples([:query_id])
      func = AWS.Sandbox.find!(@registry, __MODULE__, :get_query_results, query_id, examples)
      AWS.Sandbox.apply_func(func, [query_id, opts], examples)
    end
    ...
    def stop_query_response(query_id, opts) do
      examples = AWS.Sandbox.doc_examples([:query_id])
      func = AWS.Sandbox.find!(@registry, __MODULE__, :stop_query, query_id, examples)
      AWS.Sandbox.apply_func(func, [query_id, opts], examples)
    end
