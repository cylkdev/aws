if Code.ensure_loaded?(SandboxRegistry) do
  defmodule AWS.IAM.Sandbox do
    ...
    def get_policy_version_response(arn, _version_id, opts) do
      doc_examples = ["fn -> ...", "fn (opts) -> ..."]
      func = find!(:get_policy_version, arn, doc_examples)
    ...
    def create_policy_version_response(arn, opts) do
      doc_examples = ["fn -> ...", "fn (opts) -> ..."]
      func = find!(:create_policy_version, arn, doc_examples)
    ...
    def set_default_policy_version_response(arn, _version_id, opts) do
      doc_examples = ["fn -> ...", "fn (opts) -> ..."]
      func = find!(:set_default_policy_version, arn, doc_examples)
    ...
    def delete_policy_version_response(arn, _version_id, opts) do
      doc_examples = ["fn -> ...", "fn (opts) -> ..."]
      func = find!(:delete_policy_version, arn, doc_examples)
    ...
    def list_policy_versions_response(arn, opts) do
      doc_examples = ["fn -> ...", "fn (opts) -> ..."]
      func = find!(:list_policy_versions, arn, doc_examples)
    ...
    # ---------------------------------------------------------------------------
    # Response retrieval — MFA Devices
    # ---------------------------------------------------------------------------

    def list_mfa_devices_response(username, opts) do
      doc_examples = ["fn -> ...", "fn (opts) -> ..."]
      func = find!(:list_mfa_devices, username, doc_examples)
    ...
    # ---------------------------------------------------------------------------
    # Response retrieval — Role Policies
    # ---------------------------------------------------------------------------

    def update_assume_role_policy_response(role_name, opts) do
      doc_examples = ["fn -> ...", "fn (opts) -> ..."]
      func = find!(:update_assume_role_policy, role_name, doc_examples)
    ...
    def put_role_policy_response(role_name, _policy_name, opts) do
      doc_examples = ["fn -> ...", "fn (opts) -> ..."]
      func = find!(:put_role_policy, role_name, doc_examples)
    ...
    def get_role_policy_response(role_name, _policy_name, opts) do
      doc_examples = ["fn -> ...", "fn (opts) -> ..."]
      func = find!(:get_role_policy, role_name, doc_examples)
    ...
    def delete_role_policy_response(role_name, _policy_name, opts) do
      doc_examples = ["fn -> ...", "fn (opts) -> ..."]
      func = find!(:delete_role_policy, role_name, doc_examples)
    ...
    def list_role_policies_response(role_name, opts) do
      doc_examples = ["fn -> ...", "fn (opts) -> ..."]
      func = find!(:list_role_policies, role_name, doc_examples)
    ...
    # ---------------------------------------------------------------------------
    # Response retrieval — OIDC Providers
    # ---------------------------------------------------------------------------

    def create_open_id_connect_provider_response(url, opts) do
      doc_examples = ["fn -> ...", "fn (opts) -> ..."]
      func = find!(:create_open_id_connect_provider, url, doc_examples)
    ...
    def get_open_id_connect_provider_response(arn, opts) do
      doc_examples = ["fn -> ...", "fn (opts) -> ..."]
      func = find!(:get_open_id_connect_provider, arn, doc_examples)
    ...
    def list_open_id_connect_providers_response(opts) do
      doc_examples = ["fn -> ...", "fn (opts) -> ..."]
      func = find!(:list_open_id_connect_providers, "*", doc_examples)
    ...
    def delete_open_id_connect_provider_response(arn, opts) do
      doc_examples = ["fn -> ...", "fn (opts) -> ..."]
      func = find!(:delete_open_id_connect_provider, arn, doc_examples)
    ...
    def update_open_id_connect_provider_thumbprint_response(arn, opts) do
      doc_examples = ["fn -> ...", "fn (opts) -> ..."]
      func = find!(:update_open_id_connect_provider_thumbprint, arn, doc_examples)
    ...
    def add_client_id_to_open_id_connect_provider_response(arn, opts) do
      doc_examples = ["fn -> ...", "fn (opts) -> ..."]
      func = find!(:add_client_id_to_open_id_connect_provider, arn, doc_examples)
    ...
    def remove_client_id_from_open_id_connect_provider_response(arn, opts) do
      doc_examples = ["fn -> ...", "fn (opts) -> ..."]
      func = find!(:remove_client_id_from_open_id_connect_provider, arn, doc_examples)
    ...
    def set_list_users_responses(funcs),
      do: set_responses(:list_users, Enum.map(funcs, &{"*", &1}))
    ...
    def set_list_groups_responses(funcs),
      do: set_responses(:list_groups, Enum.map(funcs, &{"*", &1}))
    ...
    def set_remove_user_from_group_responses(tuples),
      do: set_responses(:remove_user_from_group, tuples)
    ...
    def set_list_roles_responses(funcs),
      do: set_responses(:list_roles, Enum.map(funcs, &{"*", &1}))
    ...
    def set_get_policy_version_responses(tuples), do: set_responses(:get_policy_version, tuples)

    def set_create_policy_version_responses(tuples),
      do: set_responses(:create_policy_version, tuples)

    def set_set_default_policy_version_responses(tuples),
      do: set_responses(:set_default_policy_version, tuples)

    def set_delete_policy_version_responses(tuples),
      do: set_responses(:delete_policy_version, tuples)

    def set_list_policy_versions_responses(tuples),
      do: set_responses(:list_policy_versions, tuples)

    def set_list_policies_responses(funcs),
      do: set_responses(:list_policies, Enum.map(funcs, &{"*", &1}))
    ...
    def set_list_attached_role_policies_responses(tuples),
      do: set_responses(:list_attached_role_policies, tuples)
    ...
    def set_list_mfa_devices_responses(tuples), do: set_responses(:list_mfa_devices, tuples)

    def set_update_assume_role_policy_responses(tuples),
      do: set_responses(:update_assume_role_policy, tuples)

    def set_put_role_policy_responses(tuples), do: set_responses(:put_role_policy, tuples)
    def set_get_role_policy_responses(tuples), do: set_responses(:get_role_policy, tuples)
    def set_delete_role_policy_responses(tuples), do: set_responses(:delete_role_policy, tuples)
    def set_list_role_policies_responses(tuples), do: set_responses(:list_role_policies, tuples)

    def set_create_open_id_connect_provider_responses(tuples),
      do: set_responses(:create_open_id_connect_provider, tuples)

    def set_get_open_id_connect_provider_responses(tuples),
      do: set_responses(:get_open_id_connect_provider, tuples)

    def set_list_open_id_connect_providers_responses(funcs),
      do: set_responses(:list_open_id_connect_providers, Enum.map(funcs, &{"*", &1}))

    def set_delete_open_id_connect_provider_responses(tuples),
      do: set_responses(:delete_open_id_connect_provider, tuples)

    def set_update_open_id_connect_provider_thumbprint_responses(tuples),
      do: set_responses(:update_open_id_connect_provider_thumbprint, tuples)

    def set_add_client_id_to_open_id_connect_provider_responses(tuples),
      do: set_responses(:add_client_id_to_open_id_connect_provider, tuples)

    def set_remove_client_id_from_open_id_connect_provider_responses(tuples),
      do: set_responses(:remove_client_id_from_open_id_connect_provider, tuples)
