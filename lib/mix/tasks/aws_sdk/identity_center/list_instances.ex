defmodule Mix.Tasks.AwsSdk.IdentityCenter.ListInstances do
  ...
  ## Usage
      ...
      mix aws_sdk.identity_center.list_instances [options]
  ...
  ## Examples
      ...
      mix aws_sdk.identity_center.list_instances
  """
