defmodule Mix.Tasks.AwsSdk.IdentityCenter.AttachManagedPolicy do
  ...
  ## Usage
      ...
      mix aws_sdk.identity_center.attach_managed_policy --instance-arn ARN --permission-set-arn ARN --policy-arn ARN [options]
  ...
  ## Examples
      ...
      mix aws_sdk.identity_center.attach_managed_policy \\
