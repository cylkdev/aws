defmodule Mix.Tasks.AwsSdk.IdentityCenter.ListGroups do
  ...
  ## Usage
      ...
      mix aws_sdk.identity_center.list_groups --identity-store-id ID [options]
  ...
  ## Examples
      ...
      mix aws_sdk.identity_center.list_groups --identity-store-id d-123456
  """
  ...
  def run(argv) do
    ...
    identity_store_id
    |> AwsSdk.IdentityCenter.list_identity_store_groups(opts)
