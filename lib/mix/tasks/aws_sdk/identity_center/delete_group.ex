defmodule Mix.Tasks.AwsSdk.IdentityCenter.DeleteGroup do
  ...
  ## Usage
      ...
      mix aws_sdk.identity_center.delete_group --identity-store-id ID --group-id ID [options]
  ...
  ## Examples
      ...
      mix aws_sdk.identity_center.delete_group --identity-store-id d-123456 --group-id abc123-group-id
  """
  ...
  def run(argv) do
    ...
    identity_store_id
    |> AwsSdk.IdentityCenter.delete_identity_store_group(group_id, opts)
