defmodule Mix.Tasks.AwsSdk.IdentityCenter.CreateGroupMembership do
  ...
  ## Usage
      ...
      mix aws_sdk.identity_center.create_group_membership --identity-store-id ID --group-id ID --user-id ID [options]
  ...
  ## Examples
      ...
      mix aws_sdk.identity_center.create_group_membership --identity-store-id d-123456 --group-id group-abc --user-id user-xyz
  """
  ...
  def run(argv) do
    ...
    identity_store_id
    |> AwsSdk.IdentityCenter.create_group_membership(group_id, user_id, opts)
