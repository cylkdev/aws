defmodule Mix.Tasks.AwsSdk.IAM.DeletePolicy do
  ...
  ## Usage
      ...
      mix aws_sdk.iam.delete_policy --arn ARN [options]
  ...
  ## Examples
      ...
      mix aws_sdk.iam.delete_policy --arn arn:aws:iam::123456789012:policy/MyS3ReadPolicy
  """
