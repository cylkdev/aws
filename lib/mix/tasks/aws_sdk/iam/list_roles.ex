defmodule Mix.Tasks.AwsSdk.IAM.ListRoles do
  ...
  ## Usage
      ...
      mix aws_sdk.iam.list_roles [options]
  ...
  ## Examples
      ...
      mix aws_sdk.iam.list_roles
      mix aws_sdk.iam.list_roles --path-prefix /service-roles/
  """
