defmodule Mix.Tasks.AwsSdk.IAM.DeleteUser do
  ...
  ## Usage
      ...
      mix aws_sdk.iam.delete_user --name NAME [options]
  ...
  ## Examples
      ...
      mix aws_sdk.iam.delete_user --name alice
  """
