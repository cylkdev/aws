defmodule Mix.Tasks.AwsSdk.S3.DisableEventBridge do
  ...
  ## Usage
      ...
      mix aws_sdk.s3.disable_event_bridge BUCKET [options]
  ...
  ## Examples
      ...
      mix aws_sdk.s3.disable_event_bridge my-bucket
      mix aws_sdk.s3.disable_event_bridge my-bucket --region us-east-1
  """
  ...
  def run(argv) do
    ...
    bucket = List.first(args) || Mix.raise("Usage: mix aws_sdk.s3.disable_event_bridge BUCKET")
    opts = Helpers.build_opts(parsed)

    bucket
    |> AwsSdk.S3.disable_event_bridge(opts)
