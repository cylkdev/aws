defmodule Mix.Tasks.AwsSdk.Eventbridge.DeleteConnection do
  ...
  ## Usage
      ...
      mix aws_sdk.eventbridge.delete_connection NAME [options]
  ...
  ## Examples
      ...
      mix aws_sdk.eventbridge.delete_connection my-conn
  """
  ...
  def run(argv) do
    ...
    name = List.first(args) || Mix.raise("Usage: mix aws_sdk.eventbridge.delete_connection NAME")
    opts = Helpers.build_opts(parsed)

    name
    |> AwsSdk.EventBridge.delete_connection(opts)
