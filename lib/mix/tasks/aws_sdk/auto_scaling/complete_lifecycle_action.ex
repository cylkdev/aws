defmodule Mix.Tasks.AwsSdk.AutoScaling.CompleteLifecycleAction do
  ...
  ## Usage
      ...
      mix aws_sdk.auto_scaling.complete_lifecycle_action --asg NAME \\
  ...
  def run(argv) do
    ...
    hook_name
    |> AwsSdk.AutoScaling.complete_lifecycle_action(asg, result, call_opts)
