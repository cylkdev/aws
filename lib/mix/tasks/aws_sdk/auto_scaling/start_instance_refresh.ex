defmodule Mix.Tasks.AwsSdk.AutoScaling.StartInstanceRefresh do
  ...
  ## Usage
      ...
      mix aws_sdk.auto_scaling.start_instance_refresh --asg NAME [--strategy Rolling]
  ...
  def run(argv) do
    ...
    asg
    |> AwsSdk.AutoScaling.start_instance_refresh(call_opts)
